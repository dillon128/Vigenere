...
3. Vigenere.html. HTML file containing the same code. If you do not have SageMath installed, then you can copy and paste this code into https://sagecell.sagemath.org/.
